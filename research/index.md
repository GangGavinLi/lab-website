...
Developing machine learning and deep learning frameworks for condition monitoring and fault detection in renewable energy systems. Our work includes:
- Federated learning for distributed wind systems with enhanced data privacy
...
- Wind-to-hydrogen production forecasting
...
Advancing the science of mechanical power transmission:
- Mesh stiffness modeling for high-contact-ratio gears
- Hypoid gear dynamic analysis for tidal energy applications
- Form-grinding optimization methods
- Digital twin technologies for marine turbines
...
- NSF NRT: Smart Agriculture Energy Innovation Network ($3M)
- DOE TEAMER: IVT Reliability for Tidal Energy ($171K)
- NSF EPSCoR: Predictive Monitoring for Wind Energy ($300K)
- NSF PFI-TT: Novel IVT for Tidal Energy ($550K)
